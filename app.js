...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_d3_tip__ = __webpack_require__(5);
...
const chart = (dataUrl) => {
    __WEBPACK_IMPORTED_MODULE_0_d3__["json"](dataUrl, (json) => {
...
const drawChart = (data) => {
    ...
    //tooltip
    var tooltip = __WEBPACK_IMPORTED_MODULE_1_d3_tip___default()()
        .attr('class', 'tooltip')
        .direction('nw')
        .html(d => 
    ...
    var fastest = __WEBPACK_IMPORTED_MODULE_0_d3__["min"](data, d => d.Seconds),
        slowest = __WEBPACK_IMPORTED_MODULE_0_d3__["max"](data, d => d.Seconds)
    var timeSpan = slowest - fastest

    //setup x
    var xScale = __WEBPACK_IMPORTED_MODULE_0_d3__["scaleTime"]()
        .domain([new Date((timeSpan + 10) * 1000), new Date(0)])
        .range([0, chartWidth]),
        xAxis = __WEBPACK_IMPORTED_MODULE_0_d3__["axisBottom"](xScale)
        .ticks(__WEBPACK_IMPORTED_MODULE_0_d3__["timeSecond"].every(15))
        .tickFormat(__WEBPACK_IMPORTED_MODULE_0_d3__["timeFormat"]('%M:%S')),
    ...
    var yScale = __WEBPACK_IMPORTED_MODULE_0_d3__["scaleLinear"]()
        ...
        .range([0, chartHeight]),
        yAxis = __WEBPACK_IMPORTED_MODULE_0_d3__["axisLeft"](yScale)
        .ticks(5),
...
//        .attr('y', chartHeight / 2)
    ...
    var scaleCircle = (scale) => {
        let circle = __WEBPACK_IMPORTED_MODULE_0_d3__["select"](__WEBPACK_IMPORTED_MODULE_0_d3__["event"].target),
            trans = __WEBPACK_IMPORTED_MODULE_0_d3__["transition"]()
            .duration(250)
...
__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__chart__["a" /* default */]) (dataUrl)
